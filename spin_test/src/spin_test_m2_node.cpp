...
int main(int argc, char **argv)
{
  ...
  Listener l;
  ros::Subscriber sub1 = n.subscribe("topic", 10, &Listener::chatter1, &l);
  ros::Subscriber sub2 = n.subscribe("topic", 10, &Listener::chatter2, &l);
  ros::Subscriber sub3 = n.subscribe("topic", 10, &Listener::chatter3, &l);
  ros::Subscriber sub4 = n.subscribe("topic", 10, chatter4);
